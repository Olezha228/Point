                ...
                new FileStream(dlg.FileName, FileMode.Create, FileAccess.Write))
            {
                switch (Path.GetExtension(dlg.FileName))
                {
                    ...
                    case ".soap":
                        ...
                        break;
                    case ".xml":
                        XmlRootAttribute xmlRootAttribute = new XmlRootAttribute("Points");
                        XmlAttributeOverrides xmlAttributeOverrides = new XmlAttributeOverrides();
                        var xf = new XmlSerializer(typeof(Point[]), xmlAttributeOverrides, new[] { typeof(Point3D) },
                            xmlRootAttribute, "Points");
